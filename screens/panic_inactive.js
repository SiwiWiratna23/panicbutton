      ...
      <Box flex={1} bg="#FFFFFF" safeArea={true}>
        <ScrollView px={'20px'} py={'50px'}>
          <Center>
            ...
            <Separator height={'2'} />
            <Text fontSize={'14px'} color="#ACACAC" textAlign="center" px={'20px'}>
            ...
            <Box bg="#FEF6F7" w={'223px'} h={'223px'} borderRadius="full">
              <Box bg="#FCE2E4" w={'183px'} h={'183px'} borderRadius="full" m={'20px'}>
               <Box bg="#F8B5BB" w={'143px'} h={'143px'} borderRadius="full" m={'20px'}>
              </Box>
              </Box>
            </Box>
            </Pressable>
